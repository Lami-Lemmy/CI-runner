...
void Cache::Read(u32 addr, void* memory, u32 len, bool locked)
{
  auto* value = static_cast<u8*>(memory);
...
void Cache::Write(u32 addr, const void* memory, u32 len, bool locked)
{
  auto* value = static_cast<const u8*>(memory);
