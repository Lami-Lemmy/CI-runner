...
Q_CONSTINIT static const qt_meta_stringdata_Host_t qt_meta_stringdata_Host = {
    {
        ...
        QT_MOC_LITERAL(78, 15)   // "NotifyMapLoaded"
    },
    "Host",
    "RequestTitle",
    "",
...
void Host::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->NotifyMapLoaded(); break;
        default: ;
        }
        ...
        {
            using _t = void (Host::*)();
            if (_t _q_method = &Host::NotifyMapLoaded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
