...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GraphicsWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_GraphicsWidget_t qt_meta_stringdata_GraphicsWidget = {
    {
        QT_MOC_LITERAL(0, 14)   // "GraphicsWidget"
    },
    "GraphicsWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_GraphicsWidget[] = {
...
Q_CONSTINIT const QMetaObject GraphicsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_GraphicsWidget.offsetsAndSizes,
    qt_meta_data_GraphicsWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_GraphicsWidget_t,
        // Q_OBJECT / Q_GADGET
